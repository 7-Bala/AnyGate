export function buildChatSystemPrompt({ facilityData, recommendation }) {
...
6. Respond ONLY with a single JSON object of the exact form {"reply": string, "urgency": "normal" | "elevated" | "urgent", "escalate": boolean}. No text outside the JSON.
